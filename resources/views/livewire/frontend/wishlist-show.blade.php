                        ...
                        <div class="cart-item">
                            <div class="row">
                                ...
                                <div class="col-md-2 my-auto">
                                    <label class="price">Rp {{ number_format($wishlistItem->product->selling_price, 0,
                                        ',',
                                        '.')
                                        }}</label>
                                </div>
                                ...
                                <div class="col-md-4 col-12 my-auto">
                                    <div class="remove">
                                        <button type="button" wire:click="removeWishlistItem({{ $wishlistItem->id }})"
                                            ...
                                            <span wire:loading
                                                wire:target="removeWishlistItem({{ $wishlistItem->id }})">Removing</span>
                                        </button>
                                    </div>
                                </div>
